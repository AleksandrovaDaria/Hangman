...
def hangman_countries_draw(countries, settings_difficult):
    ...
    if settings_difficult == 1:
        word = countries[countries_random_number][0]
    elif settings_difficult == 2:
        word = countries[countries_random_number][0] + " " + countries[countries_random_number][1]
    else:
        word = countries[countries_random_number][0] + " " + countries[countries_random_number][1] + " " + countries[countries_random_number][2]
    
    return list([word, countries_random_number])
...
while len(countries) > 0:
    ...
    lifes=setting[0]
    level=setting[1]
    countries_draw_result = hangman_countries_draw(countries, level)
    word = countries_draw_result[0]
    del countries[countries_draw_result[1]]
    so_far = "-" * len(word)        
    new = ""
    empty = "                                             "
